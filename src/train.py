...
if __name__ == '__main__':
    ...
    parser.add('--training_mode', dest='mode', required=True, 
               choices=['lstm', 'gcn', 'additive', 'sequential'], 
               help='Which model is going to be trained')
    parser.add('--technicals_config', dest='technicals_config', required=True, 
               help='json file with mapping of names of features to functions that create feature')
    parser.add('--epochs', dest='epochs', required=True,
               help='Number of epochs to train model for')
    parser.add('--model_name', dest='model_name', required=True,
